      ...
      <Container className=" py-3  mb-5  bg-[#E2E3E7] rounded-2xl ">
        ...
        <div className=" row">
          <div className=" py-2   my-auto">
            <ImageComponent
              image={assImg}
              className=" float-md-start float-none  pe-2 pb-2 img-fluid    "
            />

            <div
              dangerouslySetInnerHTML={{
                __html: seeMore ? data : data.slice(0, 815),
              }}
